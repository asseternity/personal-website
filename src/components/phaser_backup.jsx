...
export default function PhaserGame() {
  ...
  useEffect(() => {
    ...
    phaserSceneRef.current.scale.resize(rect.width, rect.height);
    phaserSceneRef.current.physics.world.setBounds(
      0,
      0,
      rect.width,
      rect.height
  ...
  useEffect(() => {
    // … after you instantiate your Phaser.Game and have phaserSceneRef.current …
